...
.center[.bigger[
METHODS, TOOLS AND BEHAVIOURAL SKILLS TO ADDRESS COMPLEX SOCIETY AND INDUSTRY PROBLEMS   
**The world needs you!!!! **
]]
...
.bigger[
- **Trip chaining** to access **pickup points** - **customer** as an **active agent** 

- **Dark kitchens and on-demand delivery** + **inequalities of access to food products** + **urban structure and quality of life** + **labour precarization**
      
- **Accessibility of logistics facilities for Last-mile delivery** + **Equitable access to goods** + **food systems** + **central places theory** _(Christaller, 1966)_ 

- **Impacts** of **local production and consumption** on **social justice** + **Urban Agriculture**

- **Home delivery demand** - **causal relationships** + **urban structure** + **customer profile, residence/work location, and willingness to collect goods** 
]
...
- **urban centrality measures** as a proxy for **customer accessibility**. Let's explore spatial big data and collaborative webGIS such as OpenStreetMap. 
...
.large[.yellow[
Visit to Campus Lindholmen   
26/05 - 09:30h

Talk with current students and researchers   
26/05 - 14:00h 
]]

???

We still have some meetings tomorrow! 
